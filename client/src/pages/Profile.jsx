...
const Profile = () => {
  ...
  return user ? (
    <div className="relative h-full overflow-y-scroll p-6 bg-linear-to-br from-violet-100 to-sky-100 pl-0 lg:pl-60 xl:pl-72 no-scrollbar overflow-hidden">
                  ...
                  <>
                    {post.image_urls.map((image, index) => (
                      ...
                      >
                        ...
                        />
                        <p className="absolute bottom-0 right-0 text-xs p-1 px-3 backdrop-blur-2xl text-white opacity-0 group-hover:opacity-100 transition duration-300">
