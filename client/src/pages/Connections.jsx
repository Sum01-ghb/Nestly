      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-1 border h-20 w-40 border-gray-200 bg-white shadow rounded-md z-10"
            >
        ...
        <div className="flex flex-wrap gap-6 mt-6">
          {dataArray
            ...
            .value.map((user) => (
              <div
                key={user._id}
                className="w-full max-w-88 flex gap-5 p-6 bg-white rounded-md shadow z-10"
              >
                <img
                ...
                <div className="flex-1">
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        className="w-full p-2 text-sm rounded bg-linear-to-r from-indigo-500 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-800 active:scale-95 transition text-white cursor-pointer"
                    ...
                    {currentTab === "Connections" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 flex items-center justify-center gap-1 active:scale-95 transition cursor-pointer"
                      >
