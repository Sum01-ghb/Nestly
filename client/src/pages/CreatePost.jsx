  ...
  return (
    <div className="min-h-screen relative overflow-y-scroll p-6 bg-linear-to-br from-violet-100 to-sky-100 pl-0 lg:pl-60 xl:pl-72 no-scrollbar overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Form */}
        <div className="max-w-xl bg-white p-4 sm:p-8 pb-3 rounded-xl shadow-md space-y-4">
          ...
          <div className="flex items-center justify-between py-3 border-t border-gray-300">
            ...
            <button
              ...
              className="text-sm bg-linear-to-r from-indigo-500 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-800 active:scale-95 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer"
            >
              Publish Post
            </button>
          </div>
