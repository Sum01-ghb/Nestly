            ...
            <div className="flex flex-col items-start gap-3">
              ...
              >
                ...
                <div className="group/profile relative cursor-pointer">
                  ...
                  />
                  <div className="absolute hidden group-hover/profile:flex top-0 left-0 right-0 bottom-0 bg-black/20 items-center justify-center rounded-full">
              ...
              >
                ...
                <div className="group/cover relative cursor-pointer">
                  <img
                    ...
                    alt=""
                    className="w-full max-w-xs h-40 rounded-lg bg-linear-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2"
                  />
                  <div className="absolute hidden group-hover/cover:flex top-0 left-0 right-0 bottom-0 bg-black/20 items-center justify-center rounded-lg">
                    <Pencil className="w-5 h-5 text-white" />
                  </div>
                </div>
              </label>
