...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      className={`w-60 xl:w-72 bg-linear-to-b from-sky-100 to-blue-200 border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 ${
